...
<section class="bg-dark p-4 space-y-4 w-11/12 rounded-md text-black dark:text-white">
    ...
    <div class="grid grid-cols-1 space-y-8">
        ...
        <div>
            <!-- User Input -->
            <p>SPL Token:</p>
            <Button label='Create Mint' onClick={() => createMintAccount($walletStore, $connectedCluster)}/>
        ...
        <div class="grid grid-cols-1 space-y-4 ">
            ...
            <div>
                <Button label='Create Token Account' onClick={() => createTokenAccount($walletStore, $connectedCluster, mint, tokenOwner)}/>
            </div>
        ...
        <div>
            ...
            <div>
                ...
                <Button label='Mint Token to Token Account' onClick={() => mintTokenAccount($walletStore, $connectedCluster, mint, associatedToken, tokenAmount)}/>
            </div>
        ...
        <div>
            ...
            <div>
                ...
                <Button label='Transfer Token' onClick={() => transferToken($walletStore, $connectedCluster, mint, tokenOwner, tokenDestination, tokenAmount, tokenDecimal)}/>
            </div>
