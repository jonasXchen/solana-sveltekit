...
import { type InstructionType, encodeData, decodeData } from './utils';
import type BN from 'bn.js';
import {
  JUP_STAKE_POOL_ADDRESS,
  JUP_STAKE_POOL_PROGRAM_ID,
...
export class StakePoolInstruction {
  ...
  static addValidatorToPool(params: AddValidatorToPoolParams): TransactionInstruction {
    ...
    if (stakePool.toString() == JUP_STAKE_POOL_ADDRESS.toString()) {
